    ...
    <>
      <Head>
        ...
        <BlogArticleJsonLd
          ...
          headline="Как считать реальную окупаемость геомаркетинга"
          description="Подробный разбор, как считать ROI для геомаркетинга: от сбора данных до оценки эффективности и оптимизации."
        />
      </Head>
