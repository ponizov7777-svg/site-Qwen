import article from "../../data/yandex-blog-articles/kakiye-dannyye-vazhny-dlya-kartochki-kompanii-v-yandekse.json";
...
export default function Page() {
  return (
    <ImportedYandexBusinessArticle
      slug="kakiye-dannyye-vazhny-dlya-kartochki-kompanii-v-yandekse"
      title={data.title}
