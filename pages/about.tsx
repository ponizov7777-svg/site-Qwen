  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Андрей Понизов — эксперт по геомаркетингу и привлечению клиентов для офлайн-бизнеса. Опыт работы, кейсы и подход к решению задач." />
      </Head>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>Эксперт по геомаркетингу с 8+ лет опыта</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#E65C00] mr-2">•</span>
                  <span>Работал с 150+ проектами в beauty, медицине и услугах</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#E65C00] mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-[#E65C00] mr-2">•</span>
                  <span>Обучил более 200 предпринимателей маркетингу</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                В 2015 году начал помогать местному салону красоты увеличить поток клиентов через карты. За месяц мы выросли с 5 до 35 заявок в день. Это стало отправной точкой моего пути в геомаркетинге.
              </p>
              <p className="text-gray-700 mb-4">
                Работал в digital-агентствах, управлял бюджетами до 5 млн ₽ в месяц, вел проекты для клиник, салонов, автосервисов и других офлайн-бизнесов. Понял, что системный подход дает лучшие результаты, чем разовые кампании.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Я не продаю «волшебные таблетки» и не обещаю 1000 клиентов за неделю. Моя задача — разобраться в вашем бизнесе, выявить точки роста и предложить конкретные решения, которые уже работают для похожих компаний.
              </p>
              <p className="text-gray-700">
        ...
        <section className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-[#E65C00] mb-2">150+</div>
              <div className="text-gray-600">реализованных проектов</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#E65C00] mb-2">92%</div>
              <div className="text-gray-600">клиентов возвращаются</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#E65C00] mb-2">200+</div>
